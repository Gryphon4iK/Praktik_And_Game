    ...
    public partial class Form1 : Form
    {
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            for(i = 0; i < n-1; i++)
            {
                ...
                dataGridView1.Rows[rowNumber].Cells[1].Value = sr.ReadLine();
                dataGridView1.Rows[rowNumber].Cells[2].Value = sr.ReadLine();
                dataGridView1.Rows[rowNumber].Cells["Tel"].Value = sr.ReadLine();
            }
            sr.Close();
        }
